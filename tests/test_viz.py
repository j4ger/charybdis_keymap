...
def test_html_markers():
    ...
    markers = ['id="practicePanel"', 'CODE_TO_POS', 'const LAYERS', 'data-pos', 'id="numbersToggle"', 'id="symbolsToggle"', 'generatePrompt', 'id="layerDrillToggle"', 'charToChord', 'buildChordIndex', 'id="startBtn"', 'id="stopBtn"']
